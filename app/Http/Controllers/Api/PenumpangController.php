...
class PenumpangController extends Controller
{
    ...
    public function storePenumpang(Request $request)
    {
        ...
        try {
            ...
            if ($request->expectsJson()) {
                return response()->json([
                    'success' => false,
                    'message' => 'Gagal menyimpan Data Penumpang.',
                    'error' => $e->getMessage()
                ], 500);
            }
    ...
    public function updatePenumpang(Request $request, $id)
    {
        ...
        if (now()->greaterThan($batasWaktu)) {
            if ($request->expectsJson()) {
                return response()->json([
                    'success' => false,
                    'message' => 'Perubahan hanya dapat dilakukan maksimal 3 jam sebelum keberangkatan.'
                ], 403);
            }
    ...
    public function destroyPenumpang(Request $request, $id)
    {
